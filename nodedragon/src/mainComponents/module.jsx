...
function Module(props){
    ...
    return(
        <>
        <div onMouseEnter={()=>setIsHovered(true)} onMouseLeave={()=>{setIsHovered(false)}} style={{width:"220px",height:"50px",borderRadius:"12px",display:"flex",gap:"5px",margin:"2px",backgroundColor:isHovered?"lightgreen":"white"}}>
